...
}catch (e4673){if(cljs.core.instance_QMARK_.call(null,Error,e4673))
{var e = e4673;
return null;
} else
{if("\uFDD0'else")
...
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__4676);
} else
{return false;
}
}
...
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__4679);
} else
{return false;
}
}
...
if(left)
{{
var G__4680 = [cljs.core.str(cur),cljs.core.str(cljs.core.first.call(null,left)),cljs.core.str("/")].join('');
var G__4681 = cljs.core.next.call(null,left);
cur = G__4680;
left = G__4681;
continue;
}
...
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__4687);
} else
{return false;
}
}
...
{return cljs.core.type_satisfies_.call(null,cljs.io.IFile,G__4688);
} else
{return false;
}
}
...
return (new cljs.io.File([cljs.core.str(d),cljs.core.str(cljs.io.path_separator),cljs.core.str(p1__4682_SHARP_)].join('')));
}),d.listFiles());
}),dir);
});
if(cljs.core.truth_(cljs.io.is_node_QMARK_))
{var prog_4690 = cljs.io.path_dirname.call(null,(process.argv[1]));
cljs.io._STAR_clojurescript_home_STAR_ = cljs.io.path_resolve.call(null,[cljs.core.str(prog_4690),cljs.core.str("/..")].join(''));
} else
{}
/**
...
var p = [cljs.core.str(cljs.io._STAR_clojurescript_home_STAR_),cljs.core.str("/"),cljs.core.str(p1__4689_SHARP_),cljs.core.str("/"),cljs.core.str(file)].join('');
